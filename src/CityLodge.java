...
public class CityLodge {
     ...
     */
    static HashMap<String, Room> roomCollection = new HashMap<String, Room>(50);
...
//        System.out.println(Room.roomType.Standard.ordinal());
//        System.out.println(Room.roomType.Suite.ordinal());
//        System.out.println(Room.roomStatus.Available.ordinal());
//        System.out.println(Room.roomStatus.Maintenance.ordinal());
//        System.out.println(Room.roomStatus.Rented.ordinal());
    ...
    public static void addStandardRoom() {
        ...
        try {
            ...
            if (numBedroom.equals("1") || numBedroom.equals("2") || numBedroom.equals("4")) {
                ...
                System.out.println("Invalid entry. Number of bedrooms could be 1, 2 or 4.");
                return;
            }
